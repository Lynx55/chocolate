...
public class Modificar extends javax.swing.JFrame {
    ...
    public Modificar(Integer varCod) {
        initComponents();
        this.varID.setText(varCod.toString());
        this.varID.setEnabled(false);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(varID, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void butAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butAgregarActionPerformed
        consulta = new Control();
            int precio,stock,azucar;
            String nombre,descripcion,tipo,sabor,marca;
            if (!textNombre.getText().isEmpty() || !textDescripcion.getText().isEmpty() || !textPrecio.getText().isEmpty() || !textStock.getText().isEmpty() || boxTipo.getSelectedItem()=="Seleccionar" || boxSabor.getSelectedItem()=="Seleccionar" || boxMarca.getSelectedItem()=="Seleccionar" || !opcbotConAzucar.isSelected() || !opcbotSinAzucar.isSelected()){
            stock=new Integer(textStock.getText());
            precio=new Integer(textPrecio.getText());
            Integer codigo =new Integer( varID.getText());
            nombre=textNombre.getText();
            descripcion=textDescripcion.getText();
            tipo=(String) boxTipo.getSelectedItem();
            sabor=(String) boxSabor.getSelectedItem();
            marca=(String) boxMarca.getSelectedItem();
            azucar=0; 
            ...
            Control consulta = new Control();            
                if (consulta.Modificar(nombre,descripcion,precio, stock, tipo, marca,azucar,sabor,codigo)){
                ...
                JOptionPane.showMessageDialog(this, "Ningun campo esta siendo modificado");
